...
За это время выполнялся замер скорости для 20 000 строк и анализ корректности работы на тестовых данных
...
Таким образом весь тест занимает около 7 секунд. Что я считаю хорошим показателем, для получения обратной связи.
