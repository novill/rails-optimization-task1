...
В данный момент метрика "время обработки файла с 3 250 940 строками" составляет ХХ секунд.
...
Для увеличения скорости получения результатов была выбрана метрика "время обработки файла с ХХХ строками" 
и задана граница времени в ХХ секунду. 
Таким образом весь тест занимает около ХХ секунд. Что я считаю хорошим показателем.
